...
<html lang="en">
  <head>
    ...
    />
    <title>Practical Templete Preview</title>
    <!-- plugins:css -->
    <!-- <link
      rel="stylesheet"
                ...
                <div class="card">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title" style="text-transform:capitalize;">Excel Template For Practical Courses</h4>
                          <!-- <p class="card-description">
                            Enter the facullty details to create an account
                          </p> -->
                          <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQr8hiUphv8mMJE85VZcw3cjKMypVPBW0irm3Gmr0eaZun-iL_TvC7FgaYkyLUACuV2Myh6Ckhz8elO/pubhtml?widget=true&amp;headers=false"></iframe>
