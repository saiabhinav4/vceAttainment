...
<html lang="en">
  <head>
    ...
    />
    <title>Theory Templete Preview</title>
    <!-- plugins:css -->
    <!-- <link
      rel="stylesheet"
                ...
                <div class="card">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title" style="text-transform:capitalize;">Excel Template For Theory Courses</h4>
                          <!-- <p class="card-description">
                            Enter the facullty details to create an account
                          </p> -->
                          <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRiSKTY0ExRpnNQvhZZG4Gb3pmOiCvFx2N6nHSoJZWVeclKVCve1DHYiCoFktc0O075QUvcWQ8HxeZA/pubhtml?widget=true&amp;headers=false"></iframe>
