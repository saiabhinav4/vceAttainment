...
<html lang="en">
  <head>
    ...
    />
    <title>Integrated Templete Preview</title>
    <!-- plugins:css -->
    <!-- <link
      rel="stylesheet"
                ...
                <div class="card">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title" style="text-transform:capitalize;">Excel Template For Integrated Courses</h4>
                          <!-- <p class="card-description">
                            Enter the facullty details to create an account
                          </p> -->
                          <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTINe7b8m6JJBIKf-GJtpVqjx-qBGbyMiOs3ORIeihbNBpIScjWwLI8MsL0NAs69dzJlibPE70V3t27/pubhtml?widget=true&amp;headers=false"></iframe>
