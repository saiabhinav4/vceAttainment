...
<html lang="en">
  <head>
    ...
    />
    <title>epic Templete Preview</title>
    <!-- plugins:css -->
    <!-- <link
      rel="stylesheet"
                ...
                <div class="card">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title" style="text-transform:capitalize;">Excel Template For Epic Courses, Internship </h4>
                          <!-- <p class="card-description">
                            Enter the facullty details to create an account
                          </p> -->
                          <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSTt6Rr4Y3MtzJQHNvR6U_9ejBAMWzCqBjF_Qz3XYe-Z4JiiXz9YmYK4Hz9gBreuzixpE9jHcZIZCsM/pubhtml?widget=true&amp;headers=false"></iframe>
